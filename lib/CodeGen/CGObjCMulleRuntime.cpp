...
static const char *getObjectLookupUniverseFunctionName( int optLevel) {
   switch( optLevel)
   {
   default : return( "__mulle_objc_object_get_universe_nofail_notps");
   }
}      

static const char *getUniverseLookupClassFunctionName( int optLevel) {
   switch( optLevel)
   {
   default : return( "_mulle_objc_universe_fastlookup_infraclass_nofail");
   case 1  :
   case -1 :
   case 0  : return( "_mulle_objc_universe_fastlookup_infraclass_nofail"); 
   }
}

static const char *getRuntimeLookupClassFunctionName( int optLevel) {
   switch( optLevel)
   {
