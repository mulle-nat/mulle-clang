...
// Disable the verification pass in -asserts builds.
  ...
  Args.AddLastArg(CmdArgs, options::OPT_fobjc_fmc);
  Args.AddLastArg(CmdArgs, options::OPT_fobjc_tps);
  Args.AddLastArg(CmdArgs, options::OPT_fobjc_trt);
  Args.AddLastArg(CmdArgs, options::OPT_fno_objc_aam);
  Args.AddLastArg(CmdArgs, options::OPT_fno_objc_fmc);
  Args.AddLastArg(CmdArgs, options::OPT_fno_objc_tps);
  Args.AddLastArg(CmdArgs, options::OPT_fno_objc_trt);
