...
ExprResult Sema::BuildPredefinedExpr(SourceLocation Loc,
  ...
  if (cast<DeclContext>(currentDecl)->isDependentContext())
    ...
    if (IT == PredefinedExpr::MulleObjCClassid || IT == PredefinedExpr::MulleObjCCategoryid)
    {
        uint32_t   hash;
...
ExprResult Sema::ActOnPredefinedExpr(SourceLocation Loc, tok::TokenKind Kind) {
  ...
  // @mulle-objc@ > add __OBJC_CLASS__ keyword
  case tok::kw___OBJC_CLASS__:            IT = PredefinedExpr::ObjCClass; break; // [MULLE/ALL]
  case tok::kw___OBJC_CATEGORY__:         IT = PredefinedExpr::ObjCCategory; break; // [MULLE/ALL]
  case tok::kw___MULLE_OBJC_CLASSID__:    IT = PredefinedExpr::MulleObjCClassid; break; // [MULLE/ALL]
  case tok::kw___MULLE_OBJC_CATEGORYID__: IT = PredefinedExpr::MulleObjCCategoryid; break; // [MULLE/ALL]
  // @mulle-objc@ < add __OBJC_CLASS__ keyword
